...
const employmentData = [
  { sector: "Agriculture", value: 38 },
  { sector: "Services", value: 42 },
  { sector: "Industrie", value: 11 },
  { sector: "Commerce", value: 9 },
];
...
const dashboardLinks = [
  { title: "Démographie", href: "/tableaux-de-bord/demographie", icon: Users, description: "Population & migration" },
  { title: "IPC", href: "/tableaux-de-bord/ipc", icon: Activity, description: "Indice des prix" },
  { title: "PIB", href: "/tableaux-de-bord/pib", icon: DollarSign, description: "Croissance économique" },
  { title: "Travail", href: "/tableaux-de-bord/travail", icon: Briefcase, description: "Emploi & chômage" },
    ...
    <Layout>
      ...
      <section className="bg-primary relative overflow-hidden">
        ...
        <div className="container relative py-16 md:py-24">
          ...
          {/* Hero Search Bar */}
          <form onSubmit={handleHeroSearch} className="max-w-xl mt-2 mb-6">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Rechercher des données, publications, indicateurs..."
                className="w-full h-12 pl-12 pr-4 rounded-lg bg-background/95 backdrop-blur text-foreground placeholder:text-muted-foreground border-0 ring-1 ring-border/20 focus:ring-2 focus:ring-secondary outline-none text-sm"
              />
            </div>
          </form>
      ...
      <section className="container py-12">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-xl font-bold text-foreground">Tableaux de bord</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {dashboardLinks.map((item) => (
            <DashboardCard key={item.title} title={item.title} description={item.description} href={item.href} icon={<item.icon className="h-5 w-5" />} />
          ))}
        </div>
      </section>
      ...
      <section className="container pb-12">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-xl font-bold text-foreground">Dernières publications</h2>
      ...
      <section className="bg-muted/50">
        <div className="container py-12">
          <h2 className="text-xl font-bold text-foreground mb-6">Tendances clés</h2>
