      ...
      <section className="container -mt-6 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCard
            ...
            trend="up"
            trendValue="+1.4%"
            sparklineData={[10.8, 11.0, 11.1, 11.3, 11.4, 11.6, 11.7, 11.9, 12.0]}
          ...
          <StatCard
            ...
            trend="down"
            trendValue="-2.1 pts"
            sparklineData={[28, 27, 26.5, 26, 25.5, 25, 24.8]}
          ...
          <StatCard
            ...
            trend="neutral"
            trendValue="0.0 pts"
            sparklineData={[15, 14.8, 14.6, 14.5, 14.5, 14.6, 14.5]}
          ...
          <StatCard
            ...
            trend="up"
            trendValue="+0.5 pts"
            sparklineData={[0.5, 0.8, 1.0, 1.2, 1.3, 1.5, 1.8]}
        ...
        <div className="container py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <ChartContainer
              ...
              subtitle="En millions d'habitants, 2018–2024"
              source="IHSI, Estimations de population"
            >
            ...
            <ChartContainer
              title="Emploi par secteur"
              subtitle="Répartition en pourcentage, 2024"
              source="IHSI, Enquête emploi 2024"
            >
              <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Button variant="ghost" size="sm" asChild className="gap-1 text-secondary">
            <Link to="/publications">
              Toutes les publications <ArrowRight className="h-3 w-3" />
            </Link>
          </Button>
        </div>
